...
# ======================================================================================
DRY_RUN = True       # False = actually fly (send flight setpoints to the sim)
DEBUG_VISION = False
LOGGING = True
USE_VISION = False
USE_TELEOP = False
...
# ======================================================================================
CRUISE_SPEED = 1.0     # VQ2 SAFE BASELINE (was 60) -- slow, drift-tolerant while validating
...
# ======================================================================================
A_LAT_MAX = 0.5     # VQ2 SAFE BASELINE (was 6) -- gentle corners; keep <= g*tan(roll cap)
A_LON_MAX = 0.5      # VQ2 SAFE BASELINE (was 9) -- gentle accel/brake
