...
def main() -> int:
    ...
    ap.add_argument("--policy", choices=["random", "scripted"], default="scripted")
    ap.add_argument("--episodes", type=int, default=3)
    ap.add_argument("--max-steps", type=int, default=2000)
    ap.add_argument("--out", default="artifacts/demos")
    # scripted-baseline tuning (no code edits needed)
    ap.add_argument("--forward-lean", type=float, default=0.12)
    ap.add_argument("--thrust-bias", type=float, default=0.0)
    ap.add_argument("--kp-att", type=float, default=2.5)
